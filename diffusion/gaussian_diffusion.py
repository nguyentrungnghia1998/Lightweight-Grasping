...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        ...
        B, C = x.shape[:2]
        assert t.shape == (B,)
        model_output = model(x, img, self._scale_timesteps(t), text, alpha, idx, **model_kwargs)
    ...
    def training_losses(self, model, x_start, img, t, text, alpha, idx, model_kwargs=None, noise=None):
        """
